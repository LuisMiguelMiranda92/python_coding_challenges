...
def sales_person(sales_person: pd.DataFrame, company: pd.DataFrame, orders: pd.DataFrame) -> pd.DataFrame:
    ...
    red_orders_id = orders[orders['com_id'].isin(red_com_id)]['sales_id'].unique()

    unsold_red_com = sales_person[~sales_person['sales_id'].isin(red_orders_id)]

    return unsold_red_com[['name']]
